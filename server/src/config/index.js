...
const config = {
  ...
  // Тестовый ключ API Wildberries (используется только для разработки/тестирования)
  // В мультитенантной архитектуре API ключи хранятся в базе данных для каждого предприятия
  WB_API_KEY_TEST: process.env.WB_API_KEY_TEST,
